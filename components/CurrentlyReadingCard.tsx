 ...
 */
const EmptyState = ({ colors, isDarkMode, t }: any) => (
...
const SingleBookView = ({ book, router, colors, isDarkMode, t }: any) => (
    <View className="mx-5 mb-5">
        <Text
            className="text-sm font-semibold mb-3"
            style={{
...
const MultiBookView = ({ books, router, colors, isDarkMode, t }: any) => (
    <View className="mb-5">
