...
async function test() {
  ...
  const html = await fetchUrl('https://www.kitapyurdu.com/index.php?route=product/search&filter_name=Harry%20Potter%20Felsefe');
  ...
  console.log('Fiyat formatları:', priceMatches ? priceMatches.slice(0, 10) : 'YOK');
  ...
  // Cloudflare kontrolü
  const isCloudflare = html.includes('Just a moment') || html.includes('cf-browser');
