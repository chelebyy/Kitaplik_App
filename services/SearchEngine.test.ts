...
describe("SearchEngine 🦁", () => {
    ...
    describe("search() Logic", () => {
        ...
        test("should sort results by relevance: Perfect > WrongLang > NoCover > Vague", async () => {
            ...
            const bookPerfect = {
                id: "1",
                volumeInfo: { title: "Nutuk", language: "tr", imageLinks: { thumbnail: "img" } }
            }; // +20 cover, +30 title, +15 lang = 65

            const bookWrongLang = {
                id: "2",
                volumeInfo: { title: "Nutuk", language: "en", imageLinks: { thumbnail: "img" } }
            ...
            (GoogleBooksService.searchBooks as jest.Mock).mockResolvedValue([bookNoCover, bookVague]);
            (OpenLibraryService.searchBooks as jest.Mock).mockResolvedValue([bookWrongLang, bookPerfect]);
